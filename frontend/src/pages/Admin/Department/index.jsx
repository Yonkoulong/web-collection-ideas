...
export const Department = () => {
  ...
  const handleClickOpenModalCreateDepartment = () => {
  ...
  const handleClickOpenModalDeleteDepartment = (ids) => {
    ...
    >
      <Box>
        ...
        >
          ...
          <Button variant="contained" onClick={() => handleClickOpenModalCreateDepartment()}>
            Create Department
          </Button>
        </Box>
